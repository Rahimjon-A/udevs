    ...
    <nav className=" fixed z-50 top-0 w-full  bg-white border-b ">
      <div className="flex py-[20px] mx-auto container items-center justify-between w-full ">
        ...
        <ul className="ml-auto flex items-center gap-[40px] ">
          <li
            onClick={() => setActive(1)}
            className={`text-[18px] font-semibold m-[10px] pb-[15px] ${
              active === 1 ? 'border-b-[2px]' : null
          ...
          <li
            onClick={() => setActive(2)}
            className={`text-[18px] font-semibold m-[10px] pb-[15px]  border-[--primary] ${
              active === 2 ? 'border-b-[2px]' : null
            } hover:border-b-[2px] `}
          >
          ...
          <li
            ...
            className={`${
              active === 3 ? 'border-b-[2px]' : null
            } hover:border-b-[2px] text-[18px] relative font-semibold m-[10px] pb-[15px]  border-[--primary] `}
          >
            ...
            >
              ...
              <ul className="flex flex-col gap-6">
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#mobile" className="flex gap-5 items-center">
                    <img src={drop1} alt="" /> Development of mobile applications{' '}
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#erp" className="flex gap-5 items-center">
                    <img src={drop2} alt="" /> ERP systems
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#design" className="flex gap-5 items-center">
                    <img src={drop3} alt="" /> UI / UX design
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#optimaze" className="flex gap-5 items-center">
                    <img src={drop4} alt="" /> Optimization Infrastructure
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#it" className="flex gap-5 items-center">
          ...
          <li
            onClick={() => setActive(4)}
            className={` ${
              active === 4 ? 'border-b-[2px]' : null
            } hover:border-b-[2px] text-[18px] font-semibold m-[10px] pb-[15px]  border-[--primary] `}
          >
            <a href="3"> Tools </a>
          </li>
          <li
          ...
          <li
            onClick={() => setActive(6)}
            className={`${
              active === 6 ? 'border-b-[2px]' : null
            } hover:border-b-[2px] text-[18px] group relative font-semibold m-[10px] pb-[15px]  border-[--primary] `}
          >
            ...
            >
              ...
              <ul className="flex flex-col gap-6">
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#portfolio" className="flex gap-5 items-center">
                    <img src={drop6} alt="" /> Delever
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#sms" className="flex gap-5 items-center">
                    <img src={drop7} alt="" /> SMS.uz
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#zone" className="flex gap-5 items-center">
                    <img src={drop8} alt="" /> GoodZone
                  </a>
                </li>
                <li className="hover:bg-[--primary] hover:text-white py-2 px-[20px] ">
                  <a href="#iman" className="flex gap-5 items-center">
          ...
          <li className={`text-[18px] group font-semibold m-[10px] pb-[15px]  border-[--primary] `}>
            <a href="3"> Language </a>
            <div
